...
#define AP_NAME               ("Lampara")                   // имя WiFi точки доступа, используется как при запросе SSID и пароля WiFi сети роутера, так и при работе в режиме ESP_MODE = 0
...
#define NTP_ADDRESS           ("1.es.pool.ntp.org")           // сервер времени.               если не работает, пробуйте "time.windows.com"
...
// --- ЭФФЕКТЫ -------------------------
#define RUNNING_TEXT_DEFAULT  ("Hola, que tal")                    // текст, который будет выводиться в эффекте Бегущая строка по умолчанию. его можно менять в приложении
...
String("0. Luz blanca,1,255,1,100,0;") +
String("1. Luz de color,1,255,1,100,1;") +
String("2. Cambio de color,1,255,1,255,0;") +
String("3. Luz loco,1,150,1,100,0;") +
String("4. Nubles,1,15,1,50,0;") +
String("5. Lava,5,60,1,100,0;") +
String("6. Plasma,1,30,1,100,0;") +
String("7. Arcoíris 3D,1,70,1,100,0;") +
String("8. Pavo real,1,15,1,30,0;") +
String("9. Cebra  ,1,30,7,40,0;") +
String("10. Bosque,2,30,70,100,0;") +
String("11. Océano,2,15,4,30,0;") +
String("12. Pelotas,1,255,1,100,0;") +
String("13. Pelotas no limits,1,255,1,100,0;") +
String("14. Palomitas,1,255,1,100,0;") +
String("15. Espirales,1,255,1,100,0;") +
String("16. Prisma,1,255,1,100,0;") +
String("17. Bombas de fume,1,255,1,100,0;") +
String("18. Fuego,1,255,0,255,1;") +
String("19. Fuego 2021,1,255,1,100,0;") +
String("20. Océano Pacífico,1,255,100,100,2;") +
String("21. Sombras,1,255,1,100,0;") +
String("22. DNA,1,255,1,100,0;") +
String("23. Rebaño,1,255,1,100,0;") +
String("24. Rebaño y predador,1,255,1,100,0;") +
String("25. Polillas,1,255,1,100,0;") +
String("26. Polillas dentre lámpara,1,255,1,100,1;") +
String("27. Serpientes,1,255,1,100,0;") +
String("28. Nexus,1,255,1,100,0;") +
String("29. Pelotas,1,255,1,100,0;") +
String("30. Sinus,1,255,1,100,0;") +
String("31. Metabolism,1,255,1,100,0;") +
String("32. Auroras boreales,1,255,1,100,1;") +
String("\n");
const String efList_2 = String("LIST2;") + // ======== ВТОРАЯ СТРОКА ========
String("33. Lampara de plasma,1,255,1,100,0;") +
String("34. Lampara de lava,1,255,1,100,1;") +
String("35. Lampara de líquido,1,255,1,100,1;") +
String("36. Lampara auto,1,255,1,100,0;") +
String("37. Gotas en vidrio,1,255,1,100,1;") +
String("38. Matrix,99,240,1,100,0;") +
String("39. Fuego 2012,99,252,1,100,0;") +
String("40. Fuego 2018,99,252,1,100,0;") +
String("41. Fuego 2020,120,252,1,100,0;") +
String("42. Fuego,99,252,1,100,1;") +
String("43. Torbellinos de fuego,99,252,1,100,1;") +
String("44. Torbellinos multicolor,99,252,1,100,0;") +
String("45. Magma,150,252,1,100,0;") +
String("46. Hirviendo,170,252,1,100,0;") +
String("47. Cascada,99,252,1,100,1;") +
String("48. Cascada 3D,99,252,1,100,0;") +
String("49. Piscina,99,252,1,100,1;") +
String("50. Pulso,99,252,1,100,0;") +
String("51. Pulso multicolor,99,252,1,100,0;") +
String("52. Pulso blanco,99,252,1,100,0;") +
String("53. Oscilator,99,252,1,100,0;") +
String("54. Fuente,99,252,1,100,0;") +
String("55. Hada,99,252,1,100,0;") +
String("56. Cometa,99,252,1,100,0;") +
String("57. Cometa de color,99,252,1,100,1;") +
String("58. Dos cometas,99,252,1,100,0;") +
String("59. Tries cometas,99,252,1,100,0;") +
String("60. Atracción,160,252,1,100,0;") +
String("\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
String("61. Fuego volando,99,252,1,100,0;") +
String("62. Fuego de aribe,99,252,1,100,0;") +
String("63. Serpente de arcoíris,99,252,1,100,0;") +
String("64. Papel pecado,99,252,1,100,0;") +
String("65. Parpadeo,60,252,1,100,0;") +
String("66. Humo,99,252,1,100,1;") +
String("67. Humo de multicalor,99,252,1,100,0;") +
String("68. Picasso,99,252,1,100,0;") +
String("69. Olas,220,252,1,100,0;") +
String("70. Gragea de colores,99,252,1,100,0;") +
String("71. Bloqueo de código,99,252,1,100,0;") +
String("72. Cubo de Rubic,99,252,1,100,0;") +
String("73. Nube dentre frasco,99,252,1,100,0;") +
String("74. Tormenta dentre frasco,99,252,1,100,0;") +
String("75. Lluvia,99,252,0,255,1;") +
String("76. Lluvia de multicolor,99,252,1,100,1;") +
String("77. Nieva,99,252,1,100,0;") +
String("78. Lluvia de estrellas,99,252,1,100,0;") +
String("79. Saltadores,150,252,1,100,0;") +
String("80. Luciérnagas,50,252,1,100,0;") +
String("81. Luciérnagas con colas,99,252,1,100,0;") +
String("82. Luminer,1,252,1,100,0;") +
String("83. Paintball,215,252,1,100,0;") +
String("84. Arcoíris,50,252,1,100,0;") +
String("85. Reloj,1,245,1,100,1;") +
String("86. Palabras corriendos,1,252,1,100,1;") +
